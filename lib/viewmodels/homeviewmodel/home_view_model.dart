...
class HomeViewModel with ChangeNotifier {
  ...
  Future<void> fetchAboutUs(BuildContext context) async {
    try {
      ...
      showErrorSnackbar(context, 'Error fetching aboutUS: $e');
    } finally {}
    _isLoading = false;
    notifyListeners();
  }
...
// today program
  Future<void> fetchTodayPrograms(BuildContext context) async {
    try {
      ...
      showErrorSnackbar(context, 'Error fetching today\'s programs: $e');
    } finally {
      _isLoading = false;
      notifyListeners();
    }
...
// OnGoing program
  Future<void> fetchOnGoingPrograms(BuildContext context) async {
    try {
      ...
      // Handle error
      showErrorSnackbar(context, 'Error fetching OnGoing\'s programs: $e');
    } finally {
      _isLoading = false;
      notifyListeners();
    }
...
// UpComin program
  Future<void> fetchUpComingPrograms(BuildContext context) async {
    try {
      ...
      // Handle error
      showErrorSnackbar(context, 'Error fetching UpComing\'s programs: $e');
    } finally {
      _isLoading = false;
      notifyListeners();
    }
...
// Archived program
  Future<void> fetchArchivedPrograms(BuildContext context) async {
    try {
      ...
      // Handle error
      showErrorSnackbar(context, 'Error fetching Archived\'s programs: $e');
    } finally {
      _isLoading = false;
      notifyListeners();
    }
